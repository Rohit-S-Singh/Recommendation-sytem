...
function recommendcard(e){
  console.log("abcd");
  var my_api_key = 'f18e0f5286a90cda2f42f8867979e7d1';
...
function load_details(my_api_key,title){
  ...
  console.log("--------------------------->>>>>>>>>>>>>>>>>>>>>",'http://www.omdbapi.com/?apikey=+'+my_api_key+'&t='+title)
...
function movie_recs(movie_title,movie_id,my_api_key){
  console.log("oooooooooooooooooooooo--------------->>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>",movie_title,movie_id,my_api_key)
...
function get_movie_details(movie_id,my_api_key,arr,movie_title) {
  console.log("data-------->",movie_id,my_api_key,arr,movie_title);
  $.ajax({
    type:'GET',
    url:'http://www.omdbapi.com/'+'?apikey='+my_api_key+'&t='+movie_id,
...
function show_details(movie_details,arr,movie_title,my_api_key,movie_id){
  ...
  console.log("kjdnvjkfbvjkbfvkdf--------------------->>>>>>>>>>>>>>>>>>>>>>>>>>>",arr)


  var imdb_id = movie_details.imdbID;
  var poster = 'https://m.media-amazon.com/images/M/MV5BN2EwM2I5OWMtMGQyMi00Zjg1LWJkNTctZTdjYTA4OGUwZjMyXkEyXkFqcGdeQXVyMTMxODk2OTU@._V1_SX300.jpg';
  var overview = movie_details.Plot;
  var my_genre = movie_details.Genre;
  var rating = movie_details.Rated;
  ...
  if(runtime%60==0){
   ...
   arr_poster = ['https://m.media-amazon.com/images/M/MV5BN2EwM2I5OWMtMGQyMi00Zjg1LWJkNTctZTdjYTA4OGUwZjMyXkEyXkFqcGdeQXVyMTMxODk2OTU@._V1_SX300.jpg','https://m.media-amazon.com/images/M/MV5BN2EwM2I5OWMtMGQyMi00Zjg1LWJkNTctZTdjYTA4OGUwZjMyXkEyXkFqcGdeQXVyMTMxODk2OTU@._V1_SX300.jpg','https://m.media-amazon.com/images/M/MV5BN2EwM2I5OWMtMGQyMi00Zjg1LWJkNTctZTdjYTA4OGUwZjMyXkEyXkFqcGdeQXVyMTMxODk2OTU@._V1_SX300.jpg','https://m.media-amazon.com/images/M/MV5BN2EwM2I5OWMtMGQyMi00Zjg1LWJkNTctZTdjYTA4OGUwZjMyXkEyXkFqcGdeQXVyMTMxODk2OTU@._V1_SX300.jpg']
...
function get_movie_cast(movie_id,my_api_key){
  ...
  console.log("movie cast lelo bhai", movie_id);
...
function get_movie_posters(arr,my_api_key){
  ...
  console.log("yha posters nikalne aagye hain bhai");
  for(var m in arr) {
    $.ajax({
      type:'GET',
